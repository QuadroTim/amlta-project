...
OUTPUT_FOLDER = "/Users/timskeip/Downloads/data-2/ILCD/embedding_labse"
os.makedirs(OUTPUT_FOLDER, exist_ok=True)

# Загрузка модели эмбеддингов
model = SentenceTransformer('sentence-transformers/LaBSE')  # Используем xlm-roberta-large
...
if not client.collection_exists(collection_name=COLLECTION_NAME):
    client.create_collection(
        ...
        vectors_config=VectorParams(
            size=768,  # Размерность эмбеддингов для LaBSE
...
# Папка с файлами
DATA_FOLDER = "/Users/timskeip/Downloads/data-2/ILCD/embedding_labse"  # Укажите путь к вашей папке
